 ...
 if(isAuthenticated){
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      password: Yup.string()
        // .main(8, "Must be 8 characters up")
    ...
    <main className=" bg-white w-full h-screen flex flex-col items-center justify-center px-4">
      <div className="max-w-sm w-full text-gray-600">
        <div className="text-center">
          <h2 className="text-white px-4 py-2  rounded-md bg-blue-700 text-3xl font-bold  sm:text-3xl ">
            ISTAD MOVIE
          </h2>
          <div className="mt-5 space-y-2">
            <h3 className="text-gray-800 text-2xl font-medium  sm:text-3xl"></h3>
            <p className="">
